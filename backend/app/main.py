...
from app.routers import order_groups, order_series
from app.routers import quote_items
from app.routers import inquiry_images
...
app.include_router(order_groups.router, prefix="/api/v1")
app.include_router(order_series.router, prefix="/api/v1")
app.include_router(quote_items.router, prefix="/api/v1")
app.include_router(inquiry_images.router, prefix="/api/v1")
